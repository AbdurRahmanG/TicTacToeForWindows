...
public class TicTacToe {
	...
	private void winningGame() {
		...
		if(b1 == 1 && b2 == 1 && b3 == 1) {
			JOptionPane.showMessageDialog(frame, "Player X Won!", "Tic Tac Toe : www.AbdurRahmanG.com", JOptionPane.INFORMATION_MESSAGE);
			xCount1++;
		...
		//For Player O Only
			...
			JOptionPane.showMessageDialog(frame, "Player O Won!", "Tic Tac Toe : www.AbdurRahmanG.com", JOptionPane.INFORMATION_MESSAGE);
			oCount1++;
			...
			JOptionPane.showMessageDialog(frame, "No One Won!", "Tic Tac Toe : www.AbdurRahmanG.com", JOptionPane.INFORMATION_MESSAGE);
	...
	private void initialize() {
		...
		btnExit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(JOptionPane.showConfirmDialog(frame, "Do You Realy Want to Exit!", "Tic Tac Toe. : www.AbdurRahmanG.com", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_NO_OPTION)
				{
					System.exit(0);
				}
